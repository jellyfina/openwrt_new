...
function Diy_update() {
bash <(curl -fsSL https://raw.githubusercontent.com/jellyfina/openwrt_new/build/common/main/custom/ubuntu.sh)
if [[ $? -ne 0 ]];then
...
21.02)
  ...
  bash -c "$(curl -fsSL https://github.com/jellyfina/openwrt_new/tree/main/build/common/LIENOL/19.07/package/kernel/linux/modules/netsupport.sh)"
...
19.07)
  ...
  rm -rf ${HOME_PATH}/feeds/packages/libs/libcap && svn export https://github.com/jellyfina/openwrt_new/build/common/trunk/LIENOL/19.07/feeds/packages/libs/libcap ${HOME_PATH}/feeds/packages/libs/libcap
  rm -rf ${HOME_PATH}/package/libs/libpcap && svn export https://github.com/jellyfina/openwrt_new/build/common/trunk/LIENOL/19.07/package/libs/libpcap ${HOME_PATH}/package/libs/libpcap
...
master)
  ...
  svn export https://github.com/jellyfina/openwrt_new/build/common/trunk/IMMORTALWRT/default-settings  ${HOME_PATH}/package/emortal/default-settings > /dev/null 2>&1
...
svn export https://github.com/jellyfina/openwrt_new/build/common/trunk/OFFICIAL/default-settings ${HOME_PATH}/package/default-settings > /dev/null 2>&1
...
if [[ "${REPO_BRANCH}" = "openwrt-21.02" ]]; then
  ...
  rm -rf ${HOME_PATH}/feeds/packages/devel/packr && svn export https://github.com/jellyfina/openwrt_new/build/common/trunk/OFFICIAL/1907/packr ${HOME_PATH}/feeds/packages/devel/packr
  bash -c "$(curl -fsSL https://github.com/jellyfina/openwrt_new/tree/main/build/common/LIENOL/19.07/package/kernel/linux/modules/netsupport.sh)"
  rm -rf ${HOME_PATH}/feeds/packages/libs/libcap && svn export https://github.com/jellyfina/openwrt_new/build/common/trunk/LIENOL/19.07/feeds/packages/libs/libcap ${HOME_PATH}/feeds/packages/libs/libcap
  rm -rf ${HOME_PATH}/package/libs/libpcap && svn export https://github.com/jellyfina/openwrt_new/build/common/trunk/LIENOL/19.07/package/libs/libpcap ${HOME_PATH}/package/libs/libpcap
  rm -rf ${HOME_PATH}/feeds/packages/lang/golang && svn export https://github.com/coolsnowwolf/packages/trunk/lang/golang ${HOME_PATH}/feeds/packages/lang/golang
...
if [[ -f "${ttydjson}" ]]; then
  curl -fsSL https://raw.githubusercontent.com/jellyfina/openwrt_new/build/common/main/IMMORTALWRT/ttyd/luci-app-ttyd.json -o "${ttydjson}"
fi
...
if [[ `grep -c "CONFIG_PACKAGE_luci-theme-argon=y" ${HOME_PATH}/.config` -eq '1' ]]; then
  ...
  curl -fsSL  https://github.com/jellyfina/luci-theme-argon/blob/master/htdocs/luci-static/argon/img/bg1.jpg > ${HOME_PATH}/files/www/luci-static/argon/background/moren.jpg
  if [[ $? -ne 0 ]]; then
    echo "拉取文件错误,请检测网络"
    exit 1
  fi
...
if [[ `grep -c "CONFIG_PACKAGE_ntfs-3g=y" ${HOME_PATH}/.config` -eq '1' ]]; then
  mkdir -p ${HOME_PATH}/files/etc/hotplug.d/block && curl -fsSL  https://raw.githubusercontent.com/jellyfina/openwrt_new/main/build/common/COOLSNOWWOLF/10-mount > ${HOME_PATH}/files/etc/hotplug.d/block/10-mount
  if [[ $? -ne 0 ]]; then
    echo "拉取文件错误,请检测网络"
    exit 1
  fi
...
echo
echo
if [[ ${INFORMATION_NOTICE} == "TG" ]] || [[ ${INFORMATION_NOTICE} == "PUSH" ]] || [[ ${INFORMATION_NOTICE} == "WECH" ]]; then
